    ...
    <div class="container mt-4">
				...
				<table class="table table-borderless table-sm">
				  ...
				  <tbody>
				    <tr class="table-primary">
				      ...
				      <td class="text-center">Tk {{ $vendor->due+$vendor->total }}</td>
				    </tr>
				    <tr class="table-success">
				      <td class="text-left">Total Paid</td>
				      <td class="text-center">:</td>
				      <td class="text-center">Tk {{ number_format($vendor->total) }}</td>
				    </tr>
				    <tr class="table-danger">
				      <td class="text-left">Total Due</td>
				      <td class="text-center">:</td>
				      <td class="text-center">Tk {{ number_format($vendor->due) }}</td>
				    </tr>
				  </tbody>
				</table>
            </div>
        ...
        <div class="row">
        	<div class="col-md-12">
        		...
        		<div class="ml-5">
        			<h4 style="font-size:16px;font-weight: bold">{{ $vendor->name }}</h4>
        			<p style="font-size:13px; margin:0;"><b>Contact :</b> {{ $vendor->number ?? 'N/A' }}</p>
        		</div>
        	</div>
